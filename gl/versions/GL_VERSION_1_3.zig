...
texImage1D: extern fn (target: GLenum, level: GLint, internalformat: GLint, width: GLsizei, border: GLint, format: GLenum, _type: GLenum, pixels: *c_void) void,
texImage2D: extern fn (target: GLenum, level: GLint, internalformat: GLint, width: GLsizei, height: GLsizei, border: GLint, format: GLenum, _type: GLenum, pixels: *c_void) void,
...
readPixels: extern fn (x: GLint, y: GLint, width: GLsizei, height: GLsizei, format: GLenum, _type: GLenum, pixels: *c_void) void,
...
getString: extern fn (name: GLenum) [*c]u8,
getTexImage: extern fn (target: GLenum, level: GLint, format: GLenum, _type: GLenum, pixels: *c_void) void,
...
callLists: extern fn (n: GLsizei, _type: GLenum, lists: *c_void) void,
...
feedbackBuffer: extern fn (size: GLsizei, _type: GLenum, buffer: GLfloat) void,
selectBuffer: extern fn (size: GLsizei, buffer: GLuint) void,
renderMode: extern fn (mode: GLenum) GLuint,
...
copyPixels: extern fn (x: GLint, y: GLint, width: GLsizei, height: GLsizei, _type: GLenum) void,
drawPixels: extern fn (width: GLsizei, height: GLsizei, format: GLenum, _type: GLenum, pixels: *c_void) void,
...
drawElements: extern fn (mode: GLenum, count: GLsizei, _type: GLenum, indices: *c_void) void,
...
texSubImage1D: extern fn (target: GLenum, level: GLint, xoffset: GLint, width: GLsizei, format: GLenum, _type: GLenum, pixels: *c_void) void,
texSubImage2D: extern fn (target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, width: GLsizei, height: GLsizei, format: GLenum, _type: GLenum, pixels: *c_void) void,
...
colorPointer: extern fn (size: GLint, _type: GLenum, stride: GLsizei, pointer: *c_void) void,
disableClientState: extern fn (array: GLenum) void,
edgeFlagPointer: extern fn (stride: GLsizei, pointer: *c_void) void,
enableClientState: extern fn (array: GLenum) void,
indexPointer: extern fn (_type: GLenum, stride: GLsizei, pointer: *c_void) void,
interleavedArrays: extern fn (format: GLenum, stride: GLsizei, pointer: *c_void) void,
normalPointer: extern fn (_type: GLenum, stride: GLsizei, pointer: *c_void) void,
texCoordPointer: extern fn (size: GLint, _type: GLenum, stride: GLsizei, pointer: *c_void) void,
vertexPointer: extern fn (size: GLint, _type: GLenum, stride: GLsizei, pointer: *c_void) void,
areTexturesResident: extern fn (n: GLsizei, textures: GLuint, residences: GLboolean) GLboolean,
...
drawRangeElements: extern fn (mode: GLenum, start: GLuint, end: GLuint, count: GLsizei, _type: GLenum, indices: *c_void) void,
texImage3D: extern fn (target: GLenum, level: GLint, internalformat: GLint, width: GLsizei, height: GLsizei, depth: GLsizei, border: GLint, format: GLenum, _type: GLenum, pixels: *c_void) void,
texSubImage3D: extern fn (target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, zoffset: GLint, width: GLsizei, height: GLsizei, depth: GLsizei, format: GLenum, _type: GLenum, pixels: *c_void) void,
...
compressedTexImage3D: extern fn (target: GLenum, level: GLint, internalformat: GLenum, width: GLsizei, height: GLsizei, depth: GLsizei, border: GLint, imageSize: GLsizei, data: *c_void) void,
compressedTexImage2D: extern fn (target: GLenum, level: GLint, internalformat: GLenum, width: GLsizei, height: GLsizei, border: GLint, imageSize: GLsizei, data: *c_void) void,
compressedTexImage1D: extern fn (target: GLenum, level: GLint, internalformat: GLenum, width: GLsizei, border: GLint, imageSize: GLsizei, data: *c_void) void,
compressedTexSubImage3D: extern fn (target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, zoffset: GLint, width: GLsizei, height: GLsizei, depth: GLsizei, format: GLenum, imageSize: GLsizei, data: *c_void) void,
compressedTexSubImage2D: extern fn (target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, width: GLsizei, height: GLsizei, format: GLenum, imageSize: GLsizei, data: *c_void) void,
compressedTexSubImage1D: extern fn (target: GLenum, level: GLint, xoffset: GLint, width: GLsizei, format: GLenum, imageSize: GLsizei, data: *c_void) void,
